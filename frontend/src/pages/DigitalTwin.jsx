...
const OPTIMISE_OPTIONS = ['Time', 'Cost', 'Carbon']
        ...
        <div>
          <div className="card">
            ...
            <div className="slider-container">
              ...
              <input type="range" min="1" max="100" step="0.5" value={params.oee_pct}
            ...
            <div className="slider-container">
              ...
              <input type="range" min="1" max="100" step="0.5" value={params.workforce_pct}
            ...
            <div className="slider-container">
              ...
              <input type="range" min="0" max="24" step="0.5" value={params.downtime_hrs}
            ...
            <div className="slider-container">
              ...
              <input type="range" min="0.01" max="0.50" step="0.01" value={params.energy_price}
            ...
            <div className="slider-container">
              ...
              <input type="range" min="0" max="0.30" step="0.01" value={params.demand_buffer_pct}
            ...
            <div className="form-row" style={{ marginTop:12 }}>
              ...
              <div>
                ...
                <input type="number" className="input" value={params.horizon_days} min="1" max="30"
        ...
        <div>
          {result ? (
            ...
            <div className="empty-state" style={{ height:300 }}>
              ...
              <div className="empty-state-desc">Configure parameters and click <b>Run Simulation</b> to generate a 7-day production forecast for the selected plant.</div>
            </div>
          )}
        </div>
      </div>
          ...
          <div className="two-col">
            ...
            <div className="chart-container" style={{ marginBottom:0 }}>
              ...
              <AreaChart data={chartData} margin={{ top:10, right:20, left:10, bottom:30 }}>
                ...
                <XAxis dataKey="day" tick={{ fontSize:10, fill:'var(--text-muted)', fontFamily:'monospace' }} tickLine={false} angle={-30} textAnchor="end" height={45} interval="preserveStartEnd" />
                <YAxis tick={{ fontSize:10, fill:'var(--text-muted)' }} tickLine={false} axisLine={false} width={80} tickFormatter={v=>`${(v/1000).toFixed(0)}k`} />
                <Tooltip contentStyle={{ background:'#111827', border:'1px solid #253347', borderRadius:8, fontSize:12, boxShadow:'0 8px 24px rgba(0,0,0,0.5)' }} formatter={v=>[`${v.toLocaleString()}kg`,'Carbon']} />
